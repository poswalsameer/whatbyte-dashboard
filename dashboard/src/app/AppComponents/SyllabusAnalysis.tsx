    ...
    <div className="bg-white p-6 rounded-lg shadow">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col gap-y-2">
                    <span className="text-gray-700 font-medium">HTML Tools, Forms, History</span>
                  ...
                  <div className="flex flex-col gap-y-2">
                    <span className="text-gray-700 font-medium">Tags & References in HTML</span>
                    <div className="flex gap-x-5 justify-between items-center mb-1">
                  ...
                  <div className="flex flex-col gap-y-2">
                    <span className="text-gray-700 font-medium">Tables & References in HTML</span>
                    <div className="flex gap-x-5 justify-between items-center mb-1">
                  ...
                  <div className="flex flex-col gap-y-2">
                    <span className="text-gray-700 font-medium">Tables & CSS in Basics</span>
                    <div className="flex gap-x-5 justify-between items-center mb-1">
